...
function _G.createTab(name)
    ...
    TabBtn.TextStrokeTransparency = 0
...
function _G.createFeatureWithLeftSlider(parent, configKey, speedKey, text, min, max)
    ...
    GearBtn.Text = "⚙️"
    GearBtn.TextSize = 12
    GearBtn.TextStrokeTransparency = 0
    GearBtn.ZIndex = 15
...
local flyCheat = _G.createFeatureWithLeftSlider(_G.pPlayer, "FlyMode", "FlySpeedValue", "Fly Mode", 10, 200)
local spinCheat = _G.createFeatureWithLeftSlider(_G.pPlayer, "SpinBot", "SpinSpeed", "Spin Bot", 10, 150)
local noclipCheat = _G.createCheckbox(_G.pPlayer, "Noclip", "Noclip")
...
-- ====================================================================
--  PART 5.1: MM2 BUTTONS & LEGEND
-- ====================================================================
local DEFAULT_SHOT_POS = UDim2.new(0, 15, 0, 210)
local DEFAULT_TP_POS = UDim2.new(0, 15, 0, 280)

local baseEspCheat = _G.createCheckbox(_G.pVisual, "ESPToggle", "Player ESP")

-- ЛЕГЕНДА В GAME ВКЛАДКЕ
...
legendBtn.Text = "Roles Legend"
legendBtn.TextColor3 = Color3.fromRGB(255, 200, 0)
legendBtn.Font = Enum.Font.SourceSans
legendBtn.TextSize = 12
legendBtn.TextStrokeTransparency = 0
legendBtn.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
...
legendWindow.Size = UDim2.new(0, 200, 0, 130)
legendWindow.Position = UDim2.new(0.5, -100, 0.5, -65)
...
murdererLegend.TextSize = 11
murdererLegend.TextXAlignment = Enum.TextXAlignment.Left
murdererLegend.TextStrokeTransparency = 0
murdererLegend.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
...
sheriffLegend.TextSize = 11
sheriffLegend.TextXAlignment = Enum.TextXAlignment.Left
sheriffLegend.TextStrokeTransparency = 0
sheriffLegend.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
...
innocentLegend.TextSize = 11
innocentLegend.TextXAlignment = Enum.TextXAlignment.Left
innocentLegend.TextStrokeTransparency = 0
innocentLegend.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
...
mm2SubTabBtn.TextStrokeTransparency = 0
mm2SubTabBtn.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
...
local gunEspCheat = _G.createCheckbox(_G.MM2Content, "MM2Gun", "Gun Chams")
local shotCheat = _G.createCheckbox(_G.MM2Content, "MM2Shot", "Auto Shot")
local tpGunToggle = _G.createCheckbox(_G.MM2Content, "Target", "TP Gun")
local flingCheat = _G.createCheckbox(_G.pOther, "OnePunchFling", "OnePunchFling")
...
-- ====================================================================
--  PART 5.3: FLING В ВОЗДУХ (ОТТАЛКИВАНИЕ ВВЕРХ)
-- ====================================================================
RunService.Heartbeat:Connect(function()
    ...
    if targetRoot then
        ...
        targetRoot.AssemblyLinearVelocity = direction * 100 + Vector3.new(0, 500, 0)
...
-- ====================================================================
--  PART 5.4: ИСПРАВЛЕННЫЙ AUTO-SHOT
-- ====================================================================
_G.ShotButton.MouseButton1Click:Connect(function()
    ...
    if not fired and gun:FindFirstChild("Shoot") then
...
-- ====================================================================
--  PART 5.5: ESP С ПРАВИЛЬНЫМИ ЦВЕТАМИ
-- ====================================================================
...
-- ====================================================================
--  PART 5.7: SYSTEM BUTTONS (С ИСПРАВЛЕННЫМ ПРИВАТНЫМ СЕРВЕРОМ)
-- ====================================================================
