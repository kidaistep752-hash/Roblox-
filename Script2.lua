...
-- ====================================================================
--  PART 5.3: СУПЕР МОЩНЫЙ FLING (ОТТАЛКИВАНИЕ)
-- ====================================================================
RunService.Heartbeat:Connect(function()
    ...
    if targetRoot then
        ...
        targetRoot.AssemblyLinearVelocity = direction * 400 + Vector3.new(0, 250, 0)
...
-- ====================================================================
--  PART 5.6: УЛУЧШЕННОЕ ЗАКРЫТИЕ MM2 МЕНЮ С КРЕСТИКОМ
-- ====================================================================
